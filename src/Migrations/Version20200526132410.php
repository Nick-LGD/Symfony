 ...
 */
final class Version20200526132410 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE season CHANGE id id INT AUTO_INCREMENT NOT NULL, ADD PRIMARY KEY (id)');
        ...
        $this->addSql('ALTER TABLE episode CHANGE id id INT AUTO_INCREMENT NOT NULL, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE episode CHANGE id id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE season CHANGE id id INT NOT NULL');
    }
}
